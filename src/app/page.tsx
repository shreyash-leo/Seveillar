...
export default function Home() {
  ...
  return (
    ...
    <main className="overflow-hidden">
      {/* Hero Section - Fullscreen Video Banner with Modern Glassmorphism Overlay */}
      <div ref={heroRef} className="relative h-screen w-full overflow-hidden">
        {slides.map((slide, index) => (
          ...
          >
            ...
            {/* Gradient Overlay - Light Modern Theme */}
            <div className="absolute inset-0 bg-gradient-to-br from-black/60 via-black/40 to-orange-500/30"></div>
            ...
            <div className="relative z-10 flex h-full items-center justify-between px-6 md:px-20 max-w-7xl mx-auto">
              <div className="text-white max-w-2xl animate-fade-up">
                ...
                <div className="flex flex-wrap gap-4">
                  <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-md font-semibold shadow-lg transition-all duration-300 transform hover:scale-105">
                    Explore Services
                  </button>
              ...
              {/* Floating Element - Right Side with Glassmorphism */}
              <div className="hidden lg:block w-80 animate-float">
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/30 shadow-2xl">
                  <div className="text-center text-white">
                    <div className="text-5xl font-bold text-orange-400">20+</div>
                    <div className="text-sm uppercase tracking-wider mt-1">Years Combined Experience</div>
                    <hr className="my-3 border-white/20" />
                    <div className="text-5xl font-bold text-orange-400">24/7</div>
          ...
          {slides.map((_, index) => (
            <button
              ...
              className={`h-1 rounded-full transition-all duration-300 ${
                activeSlide === index ? 'bg-orange-500 w-8' : 'bg-white/50 w-4 hover:bg-white/80'
              }`}
            />
          ))}
        </div>
      ...
      {/* Floating Statistics Cards Section - Glassmorphism */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {statistics.map((stat, index) => (
              <div 
                key={index}
                className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl p-6 text-center transform hover:-translate-y-2 transition-all duration-300 border border-white/40 group"
              >
                <div className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">
                  <span className="stat-counter" data-target={stat.value} data-suffix={stat.suffix}>0</span>
                </div>
                <div className="text-orange-500 font-semibold text-sm uppercase tracking-wider mb-1">{stat.label}</div>
      ...
      {/* About Us Section - Enhanced with More Images and Glassmorphism */}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 bg-white/90 backdrop-blur-md text-gray-800 p-4 rounded-2xl shadow-xl border border-gray-200 w-11/12 text-center">
                <div className="flex flex-wrap justify-center gap-4">
                  {certifications.map((cert, i) => (
                    <span key={i} className="text-xs font-semibold bg-orange-100 text-orange-700 px-3 py-1 rounded-full">✓ {cert}</span>
                  ))}
                </div>
              </div>
            </div>
            <div>
              <div className="inline-block bg-orange-100 px-4 py-1 rounded-full text-sm font-semibold text-orange-600 mb-4">
                About Seveillar
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Global Clinical Supply <span className="text-orange-500">Excellence</span></h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white p-4 rounded-xl shadow-md text-center border-l-4 border-orange-500">
                  <div className="text-2xl font-bold text-orange-500">2015</div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-md text-center border-l-4 border-orange-500">
                  <div className="text-2xl font-bold text-orange-500">USFDA</div>
                  <div className="text-sm text-gray-500">Audited Facility</div>
                </div>
                <div className="bg-white p-4 rounded-xl shadow-md text-center border-l-4 border-orange-500">
                  <div className="text-2xl font-bold text-orange-500">QP</div>
                  <div className="text-sm text-gray-500">Certified Operations</div>
                </div>
              </div>
              <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 rounded-md font-semibold shadow-lg transition-all duration-300 hover:shadow-xl transform hover:scale-105">
                Learn More About Us
              </button>
            </div>
          </div>
      ...
      {/* Our Services Section - Glassmorphism Cards */}
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 md:px-20">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Our <span className="text-orange-500">Premium</span> Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:-translate-y-2">
                <div className="relative h-2 bg-gradient-to-r from-orange-500 to-gray-800"></div>
                <div className="p-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-orange-100 to-orange-200 rounded-xl flex items-center justify-center mb-5 group-hover:bg-gradient-to-br group-hover:from-orange-500 group-hover:to-orange-600 transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-orange-500 group-hover:text-white transition-colors">
                      <path strokeLinecap="round" strokeLinejoin="round" d={service.icon} />
                    </svg>
                  </div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3 group-hover:text-orange-500 transition-colors">{service.title}</h3>
      ...
      {/* Why Choose Us - Modern Glassmorphism with Gradient */}
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-6 md:px-20">
          <div className="text-center mb-12">
            <div className="inline-block bg-orange-500/20 backdrop-blur-sm px-4 py-1 rounded-full text-sm font-semibold text-orange-400 mb-4">
              Why Seveillar
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">The <span className="text-orange-500">Seveillar</span> Advantage</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">Setting the standard for clinical supply excellence worldwide</p>
          </div>
      ...
      {/* Contact Section - Glassmorphism Forms */}
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-6 md:px-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Get In <span className="text-orange-500">Touch</span></h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-gray-200">
            ...
            <div className="bg-white/70 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-gray-200">
              ...
              <form className="space-y-5">
                <input type="text" placeholder="Your Name" className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-white/50" />
                <input type="email" placeholder="Email Address" className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-white/50" />
                <input type="text" placeholder="Company" className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-white/50" />
                <select className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-white/50">
                ...
                <textarea rows={4} placeholder="Message" className="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-white/50"></textarea>
                <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-lg transition-all duration-300 font-semibold shadow-md">
                  Send Message
                </button>
              </form>
            </div>
